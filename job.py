...
class Job:
    ...
    :param start_at: The time when the job should start running '%Y-%m-%d %H:%M'.
    :param duration: The duration of the job 'int'.
    :param tries: The number of times the job should be tried 'int'.
